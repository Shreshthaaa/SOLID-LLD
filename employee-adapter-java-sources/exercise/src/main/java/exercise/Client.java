...
public class Client {
  public static void main(String[] args) {
    ...
    csvRows.forEach(c -> all.add(new EmployeeCSVAdapter(c)));
    dbRows.forEach(d -> all.add(new EmployeeDBAdapter(d)));
    ldapRows.forEach(l -> all.add(new EmployeeLDAPAdapter(l)));
